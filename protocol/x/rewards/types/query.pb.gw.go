...
var (
	...
	pattern_Query_TotalSupply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"dydxprotocol", "v4", "rewards", "total_supply"}, "", runtime.AssumeColonVerbOpt(false)))
)
